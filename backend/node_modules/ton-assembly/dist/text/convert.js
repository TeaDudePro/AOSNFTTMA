...
const LSHIFT_VAR = (ctx, instr, loc) => {
    u.assertZeroArgs(instr, loc);
    return c.LSHIFT_VAR(loc);
};
exports.LSHIFT_VAR = LSHIFT_VAR;
const LSHIFT = (ctx, instr, loc) => {
    u.assertSingleArgs(instr, loc);
    const args = $.singleIntegerArg(instr);
    return c.LSHIFT(args, loc);
};
exports.LSHIFT = LSHIFT;
const QLSHIFT_VAR = (ctx, instr, loc) => {
    u.assertZeroArgs(instr, loc);
    return c.QLSHIFT_VAR(loc);
};
exports.QLSHIFT_VAR = QLSHIFT_VAR;
const QLSHIFT = (ctx, instr, loc) => {
    u.assertSingleArgs(instr, loc);
    const args = $.singleIntegerArg(instr);
    return c.QLSHIFT(args, loc);
};
exports.QLSHIFT = QLSHIFT;
const BCHKBITS_VAR = (ctx, instr, loc) => {
    u.assertZeroArgs(instr, loc);
    return c.BCHKBITS_VAR(loc);
};
exports.BCHKBITS_VAR = BCHKBITS_VAR;
const BCHKBITS = (ctx, instr, loc) => {
    u.assertSingleArgs(instr, loc);
    const args = $.singleIntegerArg(instr);
    return c.BCHKBITS(args, loc);
};
exports.BCHKBITS = BCHKBITS;
const BCHKBITSQ_VAR = (ctx, instr, loc) => {
    u.assertZeroArgs(instr, loc);
    return c.BCHKBITSQ_VAR(loc);
};
exports.BCHKBITSQ_VAR = BCHKBITSQ_VAR;
const BCHKBITSQ = (ctx, instr, loc) => {
    u.assertSingleArgs(instr, loc);
    const args = $.singleIntegerArg(instr);
    return c.BCHKBITSQ(args, loc);
};
exports.BCHKBITSQ = BCHKBITSQ;
const RSHIFT_VAR = (ctx, instr, loc) => {
    u.assertZeroArgs(instr, loc);
    return c.RSHIFT_VAR(loc);
};
exports.RSHIFT_VAR = RSHIFT_VAR;
const RSHIFT = (ctx, instr, loc) => {
    u.assertSingleArgs(instr, loc);
    const args = $.singleIntegerArg(instr);
    return c.RSHIFT(args, loc);
};
...
const QRSHIFT_VAR = (ctx, instr, loc) => {
    u.assertZeroArgs(instr, loc);
    return c.QRSHIFT_VAR(loc);
};
exports.QRSHIFT_VAR = QRSHIFT_VAR;
const QRSHIFT = (ctx, instr, loc) => {
    u.assertSingleArgs(instr, loc);
    const args = $.singleIntegerArg(instr);
    return c.QRSHIFT(args, loc);
};
...
const PUSHINT_4 = (ctx, instr, loc) => {
    u.assertSingleArgs(instr, loc);
    const args = $.singleIntegerArg(instr);
    return c.PUSHINT_4(args, loc);
};
...
const XCHG_01_LONG = (ctx, instr, loc) => {
    u.assertSingleArgs(instr, loc);
    const args = $.singleStackArg(instr);
    return c.XCHG_01_LONG(args, loc);
};
exports.XCHG_01_LONG = XCHG_01_LONG;
const XCHG_0I = (ctx, instr, loc) => {
    u.assertSingleArgs(instr, loc);
    const args = $.singleStackArg(instr);
    return c.XCHG_0I(args, loc);
};
exports.XCHG_0I = XCHG_0I;
const XCHG_IJ = (ctx, instr, loc) => {
    const argsLen = instr.args;
    if (argsLen.length !== 2) {
        throw new $.ParseError(loc, "Expected 2 arguments");
    }
    const args = $.twoStackArgs(instr);
    return c.XCHG_IJ(args[0], args[1], loc);
};
exports.XCHG_IJ = XCHG_IJ;
const XCHG_1I = (ctx, instr, loc) => {
    const argsLen = instr.args;
    if (argsLen.length !== 2) {
        throw new $.ParseError(loc, "Expected 2 arguments");
    }
    const args = $.twoStackArgs(instr);
    return c.XCHG_1I(args[0], args[1], loc);
};
...
const PUSHSLICE_REFS = (ctx, instr, loc) => {
    u.assertSingleArgs(instr, loc);
    const args = $.sliceArg(instr);
    return c.PUSHSLICE_REFS(args, loc);
};
exports.PUSHSLICE_REFS = PUSHSLICE_REFS;
const PUSHSLICE_LONG = (ctx, instr, loc) => {
    u.assertSingleArgs(instr, loc);
    const args = $.sliceArg(instr);
    return c.PUSHSLICE_LONG(args, loc);
};
...
const convertInstruction = (ctx, instr, loc) => {
    ...
    switch (name) {
        ...
        case "LSHIFT_VAR":
            return (0, exports.LSHIFT_VAR)(ctx, instr, loc);
        case "LSHIFT":
            return (0, exports.LSHIFT)(ctx, instr, loc);
        case "QLSHIFT_VAR":
            return (0, exports.QLSHIFT_VAR)(ctx, instr, loc);
        case "QLSHIFT":
            return (0, exports.QLSHIFT)(ctx, instr, loc);
        case "BCHKBITS_VAR":
            return (0, exports.BCHKBITS_VAR)(ctx, instr, loc);
        case "BCHKBITS":
            return (0, exports.BCHKBITS)(ctx, instr, loc);
        case "BCHKBITSQ_VAR":
            return (0, exports.BCHKBITSQ_VAR)(ctx, instr, loc);
        case "BCHKBITSQ":
            return (0, exports.BCHKBITSQ)(ctx, instr, loc);
        case "RSHIFT_VAR":
            return (0, exports.RSHIFT_VAR)(ctx, instr, loc);
        case "RSHIFT":
            return (0, exports.RSHIFT)(ctx, instr, loc);
        case "RSHIFT_ALT":
            return (0, exports.RSHIFT_ALT)(ctx, instr, loc);
        case "QRSHIFT_VAR":
            return (0, exports.QRSHIFT_VAR)(ctx, instr, loc);
        case "QRSHIFT":
        ...
        case "PUSHINT_4":
            return (0, exports.PUSHINT_4)(ctx, instr, loc);
        case "PUSHINT_8":
        ...
        case "XCHG_01_LONG":
            return (0, exports.XCHG_01_LONG)(ctx, instr, loc);
        case "XCHG_0I":
            return (0, exports.XCHG_0I)(ctx, instr, loc);
        case "XCHG_IJ":
            return (0, exports.XCHG_IJ)(ctx, instr, loc);
        case "XCHG_1I":
            return (0, exports.XCHG_1I)(ctx, instr, loc);
        case "DUMPSTK":
        ...
        case "PUSHSLICE_REFS":
            return (0, exports.PUSHSLICE_REFS)(ctx, instr, loc);
        case "PUSHSLICE_LONG":
            return (0, exports.PUSHSLICE_LONG)(ctx, instr, loc);
        case "PUSHCONT":
        ...
        case "GETPARAMLONG":
            return (0, exports.GETPARAMLONG)(ctx, instr, loc);
        case "INMSGPARAMS":
            return (0, exports.INMSGPARAMS)(ctx, instr, loc);
        case "GETPARAMLONG2":
            return (0, exports.GETPARAMLONG2)(ctx, instr, loc);
        case "INMSG_BOUNCE":
            return (0, exports.INMSG_BOUNCE)(ctx, instr, loc);
        case "INMSG_BOUNCED":
            return (0, exports.INMSG_BOUNCED)(ctx, instr, loc);
        case "INMSG_SRC":
            return (0, exports.INMSG_SRC)(ctx, instr, loc);
        case "INMSG_FWDFEE":
            return (0, exports.INMSG_FWDFEE)(ctx, instr, loc);
        case "INMSG_LT":
            return (0, exports.INMSG_LT)(ctx, instr, loc);
        case "INMSG_UTIME":
            return (0, exports.INMSG_UTIME)(ctx, instr, loc);
        case "INMSG_ORIGVALUE":
            return (0, exports.INMSG_ORIGVALUE)(ctx, instr, loc);
        case "INMSG_VALUE":
            return (0, exports.INMSG_VALUE)(ctx, instr, loc);
        case "INMSG_VALUEEXTRA":
            return (0, exports.INMSG_VALUEEXTRA)(ctx, instr, loc);
        case "INMSG_STATEINIT":
            return (0, exports.INMSG_STATEINIT)(ctx, instr, loc);
        case "INMSGPARAM":
            return (0, exports.INMSGPARAM)(ctx, instr, loc);
        case "DEBUGMARK":
